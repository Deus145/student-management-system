            ...
            <form role="form" method="post" action="../index3.php">
              ...
              <div class="box-body">
                <div class="form-group" id="divFirstName">
                  <label for="exampleInputStudentFirstName1">First Name</label>
                  <input type="text" class="form-control" id="exampleInputStudentFirstName1" placeholder="Enter student first name" name="first_name" id=" first_name">
                </div>
                <div class="form-group" id="divLastName">
                  <label for="exampleInputStudentLastName1">Last Name</label>
                  <input type="text" class="form-control" id="exampleInputStudentLastName1" placeholder="Enter student last name" name="last_name" id="last_name">
                </div>
                ...
                <div class="form-group" id="divCourse">
                  ...
                  <select class="form-control" id = "course_name">
                    <?php
                      ...
                      ?>
                    <?php echo "<option>".$row['course_name']."</option>" ;
                    ?>
                     <?php } ?>
                  </select>
                </div>
              ...
              <div class="box-footer">
                ...
                <input type="hidden" name="do" value="add_student" id="">
              </div>
            </form>
          </div>
        </div>
...
<script>
  ...
  $("form").submit(function (e){
      ...
      if(first_name == ""){
       ...
       if(course_name == ""){
        $('#divCourse').addClass('has-error has-feedback');
        $('#divCourse').append('<span id = "spanCourse" class = "glyphicon glyphicon-remove form-control-feedback" data-toggle = "tooltip" title= "The contact is required"></span>');
      ...
      if (first_name == "" || last_name == "" || email == "" || contact == "" || course == "" || course_code == "") {
                ...
                <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo "<option>".$row['course_name']."</option>"; ?></td>
