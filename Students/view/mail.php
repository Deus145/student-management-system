...
<div class="col-md-9">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a href="read.php">Agaba Deus</a></td>
                    <td class="mailbox-subject"><b>SMS Issue</b> - Trying to find a solution to this problem...
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-attachment"></td>
                    <td class="mailbox-date">17 mins ago</td>
                  </tr>
                  <tr>
                    <td><input type="checkbox"></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-attachment"></td>
                    <td class="mailbox-date">22 mins ago</td>
                  </tr>
                  <tr>
                    <td><input type="checkbox"></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    ...
                    <td class="mailbox-attachment"></td>
                    <td class="mailbox-date">26 mins ago</td>
                  </tr>
                  <tr>
                    <td><input type="checkbox"></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    ...
                    <td class="mailbox-attachment"></td>
                    <td class="mailbox-date">30 mins ago</td>
                  </tr>
                  <tr>
                    <td><input type="checkbox"></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    <td class="mailbox-name"><a href="read-mail.html">Agaba Deus</a></td>
                    <td class="mailbox-subject"><b>SMS Issue</b> - Trying to find a solution to this problem...
                    </td>
                    <td class="mailbox-attachment"></td>
                  ...
                  <tr>
                    ...
                    <td class="mailbox-attachment"></td>
                    <td class="mailbox-date">37 mins ago</td>
                  </tr>
                  <tr>
                    <td><input type="checkbox"></td>
                    <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                    ...
                    <td class="mailbox-attachment"></td>
                    <td class="mailbox-date">40 mins ago</td>
                  </tr>
                  </tbody>
                </table>
                <!-- /.table -->
  ...
  <!-- /.content-wrapper -->
<?php include_once('../view/templates/footer.php'); ?>s
