          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="mail.php"><i class="fa fa-inbox"></i> Inbox
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                ...
                <h5>From: help@example.com
                  <span class="mailbox-read-time pull-right">15 July. 2018 11:03 PM</span></h5>
              </div>
              <!-- /.mailbox-read-info -->
              ...
              <div class="mailbox-read-message">
                ...
                <p>You have designed a sweet new system but it still has a few issues but nontheless you will tackle them.</p>
                <p>Thanks,<br>Jane</p>
              </div>
              ...
              <ul class="mailbox-attachments clearfix">
                <li>
                  ...
                  <div class="mailbox-attachment-info">
                    <a href="#" class="mailbox-attachment-name"><i class="fa fa-paperclip"></i> July2018-report.pdf</a>
